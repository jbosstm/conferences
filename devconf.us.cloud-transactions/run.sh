...
DEFAULT_NARAYANA_VERSION=5.7.2.Final 
DEFAULT_NARAYANA_VERSION=5.9.1.Final-SNAPSHOT
DEFAULT_NARAYANA_VERSION=5.9.0.Final
[ $NARAYANA_VERSION ] || NARAYANA_VERSION=${DEFAULT_NARAYANA_VERSION}
