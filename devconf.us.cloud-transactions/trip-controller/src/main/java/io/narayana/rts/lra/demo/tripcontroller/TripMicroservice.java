...
public class TripMicroservice {
    ...
    public Booking confirm(@PathParam("bookingId") String bookingId) throws IOException, URISyntaxException {
        ...
        getStore().update(bookingId, Booking.BookingStatus.CONFIRMED);
    ...
    public Booking cancel(@PathParam("bookingId") String bookingId) throws IOException, URISyntaxException {
        ...
        getStore().update(bookingId, Booking.BookingStatus.CANCELLED);
    ...
    @Path("/{bookingId}")
    @Produces(MediaType.APPLICATION_JSON)
    public Booking getBooking(@PathParam("bookingId") String bookingId) throws IOException, URISyntaxException {
    ...
    private Booking getStatus(Booking booking) throws UnsupportedEncodingException {
        ...
        WebTarget webTarget = (flight ? flightTarget : hotelTarget).path("/booking/" + URLEncoder.encode(booking.getId(), "UTF-8"));
    ...
    private BookingStore getStore() {
        return bookingStores.getStore("trip");
    }
}
