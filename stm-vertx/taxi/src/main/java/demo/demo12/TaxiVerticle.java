...
public abstract class TaxiVerticle extends TaxiVerticleImpl {
    private String SERVICE_NAME = "taxi";
    ...
    abstract TaxiService getClone();

    @Override
    public void start(Future<Void> future) throws Exception {
        System.out.printf("starting TaxiVerticle on port 8080%n");
